...
$id = $_GET['id'];
$sql = "SELECT * FROM weAreProfessionals where id=$id";
            ...
            <div class="col-12 col-md-12 col-lg-12">
                ...
                <div class="card">
                    ...
                    <div class="card-header">
                        <h4>Edit: We Are Professionals</h4>
                    </div>


                    <!-- ############################## Form ############################## -->
                    <form action="weAreProfessionals_update.php?id=<?php echo $id ?>" method="post">
                        ...
                        <div class="card-body">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-9">
                                    <input type="text" class="form-control" placeholder="Address" value="<?php echo $address ?>" name="address">
                                </div>
                            </div>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-9">
                                    <input type="text" class="form-control" placeholder="Phone" value="<?php echo $phone ?>" name="phone">
                                </div>
                            </div>
                            ...
                            <div class="form-group row">
                                <label class="col-sm-3 col-form-label"><strong>Map</strong></label>
                                <div class="col-sm-9">
                                    <input type="text" class="form-control" placeholder="Your Google Map Link Here" value="<?php echo $map ?>" name="map">
                                </div>
                            </div>
